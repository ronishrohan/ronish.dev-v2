  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className=" fixed top-0 left-0 pointer-events-none rounded-full border-2 border-white blur-[1px]  z-[100] mix-blend-difference size-[2vw] flex items-center justify-center"
      ></motion.div>
    </AnimatePresence>
  );
};
